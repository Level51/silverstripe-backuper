...
const PROJECT_DIR = 'silverstripe-backuper';
...
class BackupAdmin extends LeftAndMain
{
    ...
    public function init()
    {
        ...
        Requirements::add_i18n_javascript(PROJECT_DIR . '/javascript/lang');
    }
    ...
    /**
     * Returns an edit form for managing BackupAdminSettings settings
     * @param null $id
     * @param null $fields
     * @return $this
     */
